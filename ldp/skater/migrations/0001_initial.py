...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SkaterProfile'
        db.create_table(u'skater_skaterprofile', (
            ...
            ('age', self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True)),
            ...
            ('gear', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'skater', ['SkaterProfile'])


    def backwards(self, orm):
        # Deleting model 'SkaterProfile'
        db.delete_table(u'skater_skaterprofile')
    ...
    models = {
        ...
        u'skater.skaterprofile': {
            'Meta': {'object_name': 'SkaterProfile'},
            'about_me': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'age': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'blank': 'True'}),
            'gear': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
